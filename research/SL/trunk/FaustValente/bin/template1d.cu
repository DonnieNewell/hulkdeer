...
#if EdgeValue
__device__ DTYPE EdgeValue(dim3 input_size, int x, DTYPE value)
{
@EdgeValue@
}
#endif
...
extern "C" {
void @FunctionName@Kernel(dim3 input_size, dim3 stencil_size, int iters, 
                          ...
                          @ScalarVariables@)
{
    ...
    if (!inside)
    {
        value = EdgeValue(input_size, x, value @ScalarVariableNames@);
    }
#endif
