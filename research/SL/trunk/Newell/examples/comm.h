...
void copySegment(NeighborTag2D, SubDomain*, DTYPE*, const int [], const bool,
        int*);
bool sendSegment(const NeighborTag3D, SubDomain*, int*, DTYPE*, const int, MPI_Request*);
bool sendSegment(const NeighborTag2D, SubDomain*, int*, DTYPE*, const int, MPI_Request*);
...
void exchangeGhostZones2D(Node*, const int[], int*, DTYPE***, MPI_Request*);
void exchangeGhostZones3D(Node*, const int[], int*, DTYPE***, MPI_Request*);
