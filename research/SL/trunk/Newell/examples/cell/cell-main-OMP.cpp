/* -*- Mode: C ; indent-tabs-mode: nil ; c-file-style: "stroustrup" -*-
    ...
    Author: Donnie Newell derived from code by Greg Faust, Sal Valente, and Jiayuan Meng


    File:   cell-main-OMP.cpp     Contains a main routine to drive the cell example.
 */
